...
// Emit permission.request events for each tool in perm_tools input.
// Format: comma-separated "tool[|fingerprint]" entries.
if permTools := req.GetInput()["perm_tools"]; permTools != "" {
