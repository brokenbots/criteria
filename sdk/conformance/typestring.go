...
//     the wire boundary.
func testTypeStringStability(t *testing.T, s Subject) { //nolint:funlen,gocognit // stability test enumerates all envelope types with submit/retrieve/compare steps
